...
## ⚠️ **IMPORTANT NOTICE**
**This repository is a minimal baseline/framework for Derril Water Solar Park when it's API comes online and is WIP**
...
Home Assistant custom componant for Derril Water Solar Parm

> **Not affiliated with Derril Water Solar Park.** This is a community integration that
...
1. Basic config flow (API key + site name)
